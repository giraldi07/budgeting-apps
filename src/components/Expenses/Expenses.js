        ...
        <Col md={10} className="main">
            ...
            <Row className="grid-row">
              ...
              <Col md={4}>
                <Form.Group>
                  ...
                  <Form.Control type="number" value={amount} onChange={(e) => setAmount(e.target.value)} placeholder="Expense Amount in Rupiah" required />
                </Form.Group>
              </Col>
            </Row>
            <Row className="grid-row">
                ...
                <Row>
                  <Col md={8}>
                    <div>
                      ...
                      <p>Amount: {formatRupiah(expense.amount)}</p>
                  ...
                  <Col md={4} className="text-end">
                    ...
                    <Button variant="danger" className="ms-2" onClick={() => handleRemove(expense.id)}>
          ...
          <Row className="mt-4">
            ...
            <Col md={6} className="text-end">
              <Button variant="secondary" disabled={currentPage === 1} onClick={handlePreviousPage}>
                <FontAwesomeIcon icon={faArrowCircleLeft} /> Previous
              </Button>
              <Button variant="secondary" className="ms-2" disabled={currentPage * expensesPerPage >= filteredExpenses.length} onClick={handleNextPage}>
